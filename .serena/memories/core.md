...
- `sim-cluster/src/{lib,topology,server,arbiter,control,lifecycle,cluster_stop,time_sync,node}.rs`, `sim-cluster/src/ipc/{mod,hash,names,wire,runtime,control_bus,uart_bus}.rs`, bins `cluster_{server,arbiter,node}.rs`.
