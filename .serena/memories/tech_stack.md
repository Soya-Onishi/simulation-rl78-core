...
- `sim-cluster` IPC: `iceoryx2` 0.9 pub/sub (control a2n/n2a + per-edge UART), `xxhash-rust` (board_id → u64), `iceoryx2-bb-system-types` (isolated root_path). No UDS/SHM ring/`raw_sync`.
