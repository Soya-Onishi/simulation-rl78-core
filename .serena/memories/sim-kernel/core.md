...
- `wiring`: typed unidirectional `Wire<T>` / typestate (1-N or N-1) / `SolidWire` / `WiringBuilder` / dummy source·sink. Immediate sink callbacks. Nested drive logged and dropped.
